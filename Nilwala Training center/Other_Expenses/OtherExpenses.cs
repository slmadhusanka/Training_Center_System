...
namespace Nilwala_Training_center.Payments
{
    public partial class OtherExpenses : Form
    {
        ...
        public void Petty_Cash_Code()
        {
            ...
            //=====================================================================================================================
            string sql = "select PettyCashID from OtherExpenses";
            ...
            if (!dr.Read())
            {
                PettyCash_ID.Text = "OES1001";
                lblPeetyIDCredit.Text = "OES1001";
                lblRecivedPettyCashID.Text = "OES1001";
                cmd.Dispose();
                dr.Close();
            }
            else
            {
                ...
                string sql1 = "select TOP 1 PettyCashID from OtherExpenses ORDER BY PettyCashID DESC";
                ...
                while (dr7.Read())
                {
                    ...
                    PettyCash_ID.Text = "OES" + no;
                    lblPeetyIDCredit.Text = "OES" + no;
                    lblRecivedPettyCashID.Text = "OES" + no;
        ...
        public void loadbalance()
        {
            try
            {
                ...
                //=====================================================================================================================
                string sql = "select Current_Bal from OtherExpensesBALANCE";
                SqlCommand cmd = new SqlCommand(sql, Conn);
                SqlDataReader dr = cmd.ExecuteReader();
                ...
                else
                {
                    ...
                    Conn1.Open();
                    string sql1 = " SELECT TOP 1 Current_Bal FROM OtherExpensesBALANCE order by [Bal_ID] DESC";
        ...
        public void loadReason(ComboBox Cmname)
        {
            ...
            try
            {
                ...
                cnn.Open();
                String insertReason = "SELECT * FROM OtherExpensesReason ";
        ...
        public void getCreateReasoncode()
        {
            ...
            try
            {
                ...
                //=====================================================================================================================
                string sql = "select PettyID from OtherExpensesReason";
                SqlCommand cmd = new SqlCommand(sql, Conn);
                SqlDataReader dr = cmd.ExecuteReader();
                ...
                else
                {
                    ...
                    string sql1 = " SELECT TOP 1 PettyID FROM OtherExpensesReason order by PettyID DESC";
                    SqlCommand cmd1 = new SqlCommand(sql1, Conn);
                    SqlDataReader dr7 = cmd1.ExecuteReader();
       ...
       // Cmname.Items.Add("<New>");
            ...
            try
            {
                ...
                if (dgResult == DialogResult.Yes)
                {
                    for (int i = 0; i <= listView1.Items.Count - 1; i++)
                    {
                        ...
                        conz.Open();
                        String selectPetid = "select top 1 Balance from OtherExpenses order by peety_ID desc";
                        ...
                        SqlConnection cnn = new SqlConnection(IMS);
                        cnn.Open();
                        string insert1 = @"INSERT INTO [OtherExpenses] ([ptDate],[PettyCashID],[Reason] ,[Discription],[Receiver] ,[Payer],[Received_Amount] ,[Paid_amount] ,[Balance],[UserID]) VALUES(@Datept,@PettyCashID,@Reason,@Discription,@Receiver,@Payer,@Received_Amount,@Paid_amount,@Balance,@User1)";
                    ...
                    if (!dr.Read())
                    {
                        ...
                        cnnz.Open();
                        string insert1z = @"INSERT INTO OtherExpensesBALANCE (Petty_Cash_ID, Petty_Cash_Auto_ID, Update_Status, Amount, Current_Bal,[Current_Date]) VALUES('" + PettyCash_ID.Text + "','00','Credited','" + TotAmount.Text + "','" + Now_balance_Payment + "','" + DateTime.Now + "')";
                        SqlCommand cmmz = new SqlCommand(insert1z, cnnz);
                       // MessageBox.Show(insert1z);
                    ...
                    else
                    {
                        ...
                        SqlConnection cnnz = new SqlConnection(IMS);
                        cnnz.Open();
                        string insert1z = @"INSERT INTO OtherExpensesBALANCE (Petty_Cash_ID, Petty_Cash_Auto_ID, Update_Status, Amount, Current_Bal,[Current_Date]) VALUES('" + PettyCash_ID.Text + "','00','Credited','" + TotAmount.Text + "','" + current_Bal + "','"+DateTime.Now+"')";
                        SqlCommand cmmz = new SqlCommand(insert1z, cnnz);
        ...
        private void cmbReson_Click(object sender, EventArgs e)
        {
            loadReason(cmbReson);
        ...
        {
            #region // visibal label and add new reason-----------------------------------------------------------------
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (addcheck == DialogResult.OK)
                {
                    ...
                    SqlConnection cnn = new SqlConnection(IMS);
                    cnn.Open();
                    string insernewid = "insert into [OtherExpensesReason]([PettyID],[Reason],[Active_Deactive])values('" + lblRealD.Text + "','" + textBox1.Text + "','" + 1 + "') ";
        ...
        private void btnTab2save_Click(object sender, EventArgs e)
        {
            ...
            if (checkadd == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    conx.Open();
                    string InsertUpdate = "insert into OtherExpenses values ('" + lblRecivedPettyCashID.Text + "','" + DateTime.Now.ToString() + "','" + comboBox2.Text + "','" + NewDiscri + "','" + RecivedBy.Text + "','" + PayedTo.Text + "','" + RecievedAmount.Text + "','" + "0.0" + "','" + TopBalTot + "','" + LgUser.Text + "')";
                    ...
                    //string UpdateDate = @"UPDATE  OtherExpenses SET Reason='" + comboBox2.Text + "',Discription='" + txttab2Desceip.Text + "', Payer='" + PayedTo.Text + "',Receiver='" + RecivedBy.Text + "',  Received_Amount='" + RecievedAmount.Text + "', Balance='" + BalanceAmount.Text + "' WHERE (PettyCashID='" + PetID.Text + "' AND peety_ID='" + Auto_Pet_ID.Text + "')";
                    ...
                    SqlConnection cnnz = new SqlConnection(IMS);
                    cnnz.Open();
                    string insert1z = @"INSERT INTO OtherExpensesBALANCE (Petty_Cash_ID, Petty_Cash_Auto_ID, Update_Status, Amount, Current_Bal,[Current_Date]) VALUES('" + PetID.Text + "','" + Auto_Pet_ID.Text + "','Updated','" + RecievedAmount.Text + "','" + current_Bal + "','" + DateTime.Now + "')";
                    SqlCommand cmmz = new SqlCommand(insert1z, cnnz);
                    cmmz.ExecuteNonQuery();
        ...
        private void btnSavecredit_Click(object sender, EventArgs e)
        {
          ...
          //  {
                ...
                if (dgResult == DialogResult.Yes)
                {
                    ...
                    if (Rbt_Frm_Main_cash.Checked == true)
                    {
                        Balance_Status = "Main_Cash_Debit_To_Other_Expenses";
                    }
                    ...
                    if (Rbt_Frm_Main_cash.Checked == true)
                    {
                        ...
                        try
                        {
                            ...
                            cnnselect.Open();
                            string selecttop = "SELECT TOP 1 Current_Bal FROM [OtherExpensesBALANCE] order by Bal_ID desc";
                    ...
                    #region data insert to Expenses Cash_Balance ----------------------------------------------
                    ...
                    for (int i = 0; i <= listView2.Items.Count - 1; i++)
                    {
                        ...
                        SqlConnection cnn = new SqlConnection(IMS);
                        cnn.Open();
                        string insertBalance = @"insert into [OtherExpensesBALANCE]( [Petty_Cash_ID],[Petty_Cash_Auto_ID],[Update_Status],[Amount],[Current_Bal],[Current_Date]) values( @Petty_Cash_ID,@Petty_Cash_Auto_ID,@Update_Status,@Amount,@Current_Bal,@Current_Date)";
                        ...
                        cmmCre.Parameters.AddWithValue("Current_Date", DateTime.Now);
                    ...
                    #region data insert to OtherExpenses ----------------------------------------------
                    ...
                    for (int i = 0; i <= listView2.Items.Count - 1; i++)
                    {
                        ...
                        SqlConnection cnnselect = new SqlConnection(IMS);
                        cnnselect.Open();
                        string selecttop = "select top 1 Balance from OtherExpenses order by peety_ID desc";
                        SqlCommand cmmdad = new SqlCommand(selecttop, cnnselect);
                        SqlDataReader dr = cmmdad.ExecuteReader();
                        ...
                        SqlConnection cnn = new SqlConnection(IMS);
                        cnn.Open();
                        string insertBalance = @"INSERT INTO [OtherExpenses] ([PettyCashID],[ptDate],[Reason],[Discription] ,[Receiver] ,[Payer],[Received_Amount] ,[Paid_amount],[Balance],[UserID])VALUES(@PettyCashID,@ptDate,@Reason,@Discription ,@Receiver ,@Payer,@Received_Amount ,@Paid_amount,@Balance,@UserID)";
                        SqlCommand cmmCre = new SqlCommand(insertBalance, cnn);
